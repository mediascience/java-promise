...
public class DegenerateDeferXTest {
    ...
    public void testBrokenDeferBroken() {
         ...
         */
        this.broken.deferX(() -> this.src.get()).on(Throwable.class, this.c);
    ...
    public void testBrokenDeferFulfilled() {
         ...
         * hack around eclipse bug. Javac doesn't require the lambda expression.
         */
        this.broken.deferX(() -> this.src.get()).forEach(this.c);
    ...
    public void testBrokenFinalizedOnlyOnce() {
         ...
         * hack around eclipse bug. Javac doesn't require the lambda expression.
         */
        final Promise<?> fin = this.broken.deferX(() -> this.src.get());
    ...
    public void testFulfilledDeferBroken() {
         ...
         * hack around eclipse bug. Javac doesn't require the lambda expression.
         */
        this.fulfilled.deferX(() -> this.src.get()).on(Throwable.class, this.c);
    ...
    public void testFulfilledDeferFulfilled() {
         ...
         * hack around eclipse bug. Javac doesn't require the lambda expression.
         */
        this.fulfilled.deferX(() -> this.src.get()).forEach(this.c);
    ...
    public void testFulfilledFinalizedOnlyOnce() {
         ...
         * hack around eclipse bug. Javac doesn't require the lambda expression.
         */
        final Promise<?> fin = this.fulfilled.deferX(() -> this.src.get());
