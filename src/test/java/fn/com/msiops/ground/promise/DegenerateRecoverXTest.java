...
public class DegenerateRecoverXTest {
    ...
    public void testBoundOnlyOnce() {
        ...
        final Promise<?> recovery = this.broken.recoverX(Exception.class,
    ...
    public void testBrokenBroken() {
        ...
        this.broken.recoverX(Exception.class, err -> this.rf.apply(err)).on(
    ...
    public void testBrokenFulfilled() {
        ...
        this.broken.recoverX(Exception.class, err -> this.rf.apply(err))
                .forEach(this.c);
    ...
    public void testBrokenNullSelectorIllegal() {
        ...
        this.fulfilled.recoverX((Class<Exception>) null,
                err -> this.rf.apply(err));
    ...
    public void testBrokenNullTransformedIllegal() {
        ...
        this.broken.recoverX(Throwable.class, null);
    ...
    public void testContinuationErrorSentDownstream() {
        ...
        this.broken.recoverX(Throwable.class, err -> {
            throw x;
    ...
    public void testFulfilled() {
        ...
        this.fulfilled.recoverX(Exception.class, err -> this.rf.apply(err))
                .forEach(this.c);
