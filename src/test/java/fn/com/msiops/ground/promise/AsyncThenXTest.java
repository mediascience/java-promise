...
public class AsyncThenXTest {
    ...
    public void setup() {
        ...
        this.r = this.outer.promise().thenX(this::doWork, this::doRetry);
    ...
    public void testFulfilledNullPromiseFunIllegal() {
        ...
        this.outer.succeed(this.value);
        this.outer.promise().thenX(null, this::doRetry);
    ...
    public void testFulfilledNullRetryFunIllegal() {
        ...
        this.outer.succeed(this.value);
        this.outer.promise().thenX(this::doWork, null);
