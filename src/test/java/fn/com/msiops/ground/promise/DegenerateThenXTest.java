...
public class DegenerateThenXTest {
    ...
    public void testFromBroken() {
        ...
        this.broken.thenX(this::doWork, this::doRetry).on(Throwable.class,
                this.c);
    ...
    public void testFulfilledNullPromiseFunIllegal() {
        ...
        this.fulfilled.thenX(null, this::doRetry);
    ...
    public void testFulfilledNullRetryFunIllegal() {
        ...
        this.fulfilled.thenX(this::doWork, null);
    ...
    public void testGiveUp() {
        ...
        this.fulfilled.thenX(this::doWork, this::doRetry).on(Throwable.class,
                this.c);
    ...
    public void testSucceedsFirstTime() {
        ...
        this.fulfilled.thenX(this::doWork, this::doRetry).forEach(this.c);
