...
public class DegenerateFlatMapXTest {
    ...
    public void testBoundOnlyOnce() {
         ...
         */
        final Promise<?> mapped = this.fulfilled
                .flatMapX(i -> this.mf.apply(i));
    ...
    public void testFlatMapBroken() {
         ...
         * hack around eclipse bug. Javac doesn't require the lambda expression.
         */
        this.broken.flatMapX(i -> this.mf.apply(i)).on(Throwable.class, this.c);
    ...
    public void testFlatMapFulfilledBroken() {
         ...
         * hack around eclipse bug. Javac doesn't require the lambda expression.
         */
        this.fulfilled.flatMapX(i -> this.mf.apply(i)).on(Throwable.class,
                this.c);
    ...
    public void testFlatMapFulfilledFulfilled() {
         ...
         * hack around eclipse bug. Javac doesn't require the lambda expression.
         */
        this.fulfilled.flatMapX(i -> this.mf.apply(i)).forEach(this.c);
